                    ...
                    <div className="bridalSets-necklaces flex">
                        <div className="bridalSets flex dmg-lft">
                            ...
                            <div className="bridalSets-img dsk-bridalSets-img">
                                <img src="/images/dmgsetwet.png" alt="ring_promotion_banner_desktop_2" loading="lazy" />
                            </div>
                            <div className="mb-bridalSets-img">
                                <img src="/images/dmgsetwet.png" alt="ring_promotion_banner_mobile_2" loading="lazy" />
                            </div>
                        </div>
                        <div className="bridalSets flex dmd-rgt">
                            <div className="bridalSets-text">
                                ...
                                ></span>
                                <div className="bridalSets-btn">
                                    <Link className="button" to="/engagement-rings/start-with-a-diamond/lab">
                                        Shop Now
                                    </Link>
                                </div>
                            </div>
                            <div className="bridalSets-img dsk-bridalSets-img">
                                <img src="/images/diamondSet2.png" alt="ring_promotion_banner_desktop_2" loading="lazy" />
                            </div>
                            <div className="mb-bridalSets-img">
                                <img src="/images/diamondSet2.png" alt="ring_promotion_banner_mobile_2" loading="lazy" />
                            </div>
                        </div>
