...
export const GemstoneReviews = () => {
    return (
        <section className="testimonial-rings p-t">
                    ...
                    <div className="testimonial-mian-wrrap">
                        <div className="testy-bar">
                            <div className="top-img-name-bar">
                                <div className="imgg">
                                <img src="/images/GemReview-1.jpg" alt="client-img" />
                                </div>
                        ...
                        <div className="testy-bar">
                            <div className="top-img-name-bar">
                                <div className="imgg">
                                <img src="/images/GemReview-2.jpg" alt="client-img" />
                                </div>
                                <div className="client-name">
                                    <p>Charlie</p>
                                </div>
                        ...
                        <div className="testy-bar">
                            <div className="top-img-name-bar">
                                <div className="imgg">
                                    <img src="/images/GemReview-3.jpg" alt="client-img" />
                                </div>
                                <div className="client-name">
                                    <p>Dakota</p>
                                </div>
